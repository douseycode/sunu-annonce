...
$user_id = $_SESSION['id'];
$annonces = getRejetAnnonceId($user_id);
			...
			<div class="col-lg-4">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li >
								<a href="my_annonce.php"><i class="fa fa-user"></i> Mes annonces</a>
							</li>
							
							<li class="active">
								<a href="annonce-rejeter.php"><i class="fa fa-trash"></i> Annonce Rejeter</a>
							</li>
                    ...
                    <?php while ($annonce = $annonces->fetch()) : ?>
                        <tr>
                            ...
                            <td class="product-details">
                                ...
                                <span class="add-id"><strong>Ad ID:</strong> <?= $annonce['id'] ?></span>
                                <span><strong>Date publication: </strong><time><?= $annonce['date_creation'] ?></time> </span>
                                <span style="color: red;"><strong>Status</strong><?= $annonce['etat'] ?></span>
